<template>
    <div>
        <q-card class="q-ma-md q-pa-md" elevation="13">
            <h3> <q-icon name="domain" /> Mantendor de Centros</h3>
                ...
                <q-table bordered title="Centros" :rows="centros" :columns="columns" :rows-per-page-options="[10]"
                    ...
                    <template v-slot:body-cell-actions="props">
                        <q-td :props="props">
                            ...
                            <q-btn color="primary" icon="delete" @click="eliminarCentro(props.row)" flat />
                        </q-td>
                    </template>
        ...
        <q-dialog v-model="dialogCentro" persistent>
            <q-card class="q-gutter-sm my-card" style="width: 700px; max-width: 80vw">
                ...
                <q-card-section>
                    ...
                    <q-input v-model="centro.direccion" label="Dirección" stack-label dense lazy-rules
                        color="primary" />
    ...
    methods: {
        ...
        eliminarCentro(row) {
            Notify.create({
                ...
                message: "quieres eliminar el Centro?",
                actions: [
                    {
                        label: "Eliminar",
                        handler: async () => {
